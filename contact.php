    ...
    <main class="page contact-page">
        <section class="portfolio-block contact">
            <div class="container">
                ...
                <form data-aos="zoom-in-up" data-aos-duration="1500" data-bss-recipient="4c7cf26e9b3f2f682adc8d185716b13c">
                    <div class="form-group"><label for="name">Your Name</label><input class="form-control item" type="text" id="name" placeholder="Enter your name" name="name" maxlength="30"></div>
                    <div class="form-group"><label for="subject">Subject</label><input class="form-control item" type="text" id="subject" placeholder="Enter Subject" name="subject" required="" maxlength="60"></div>
                    <div class="form-group"><label for="email">Email</label><input class="form-control item" type="email" id="email" name="email" placeholder="Enter your email" required="" inputmode="email"></div>
                    <div class="form-group"><label for="message">Message</label><textarea class="form-control item" id="message" name="msg" placeholder="Write your message" rows="5" required="" maxlength="255" autocomplete="off" spellcheck="true"></textarea></div>
                    <div class="form-group"><button class="btn btn-success btn-lg" type="submit">Submit</button></div>
                </form>
            </div>
        </section>
    </main>
