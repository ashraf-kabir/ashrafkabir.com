        ...
        <div class="container"><a class="navbar-brand logo" href="index.php">Ashraf Kabir</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navbarNav"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div
                ...
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="projects.php">Projects</a></li>
        ...
        <section class="portfolio-block projects-cards">
            <div class="container" data-aos="zoom-in" data-aos-duration="1000">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card border-0"><a href="#"><img class="card-img-top scale-on-hover" src="assets/img/project-images/image5.jpg" alt="Card Image"></a>
                            <div class="card-body">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card border-0"><a href="#"><img class="card-img-top scale-on-hover" src="assets/img/project-images/image6.jpg" alt="Card Image"></a>
                            <div class="card-body">
                                <h6><a href="#">Lorem Ipsum</a></h6>
                                <p class="text-muted card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc quam urna.</p>
                            </div>
