            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="card border-0"><a href="project-page-1.php"><img
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card border-0"><a href="project-page-2.php"><img
                                        class="card-img-top scale-on-hover"
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card border-0"><a href="project-page-3.php"><img
                                        class="card-img-top scale-on-hover"
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card border-0"><a href="project-page-4.php"><img
                                        class="card-img-top scale-on-hover"
