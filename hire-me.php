        ...
        <div class="container"><a class="navbar-brand logo" href="index.php">Ashraf Kabir</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navbarNav"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div
                ...
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="hire-me.php">Hire me</a></li>
                </ul>
        </div>
        </div>
    </nav>
        ...
        <section class="portfolio-block hire-me">
            <div class="container">
                ...
                <form data-aos="zoom-in" data-aos-duration="1000" data-bss-recipient="4c7cf26e9b3f2f682adc8d185716b13c">
                    <div class="form-group"><label for="subject">Subject</label><select class="form-control" id="subject" required=""><option value="" selected="">Choose Subject</option><option value="1">Web Developer</option><option value="2">Image Editor</option><option value="3">Content Creator</option></select></div>
                    <div
                        class="form-group"><label for="email">Email</label><input class="form-control" type="email" id="email" name="email2" required="" placeholder="Enter your email" inputmode="email"></div>
            <div class="form-group"><label for="message">Message</label><textarea class="form-control" id="message" rows="5" name="msg2" placeholder="Write your message" maxlength="255" required="" autocomplete="off"></textarea></div>
            <div class="form-group">
                <div class="form-row">
                    <div class="col-md-6"><label for="hire-date">Date</label><input class="form-control" id="hire-date" type="date" required="" name="date"></div>
                    <div class="col-md-6 button"><button class="btn btn-success btn-block" type="submit">Hire Me</button></div>
                </div>
            </div>
            </form>
            </div>
