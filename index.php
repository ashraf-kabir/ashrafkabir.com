...
<body>
    ...
    <main class="page lanidng-page">
        <section class="portfolio-block block-intro">
            <div class="container" data-aos="zoom-in-up">
                <div class="pulse animated avatar" style="background-image: url(&quot;assets/img/avatars/avatar.jpg&quot;);"></div>
                <div class="about-me">
        ...
        <section class="portfolio-block photography">
            <div class="container">
                <div class="row no-gutters">
                    <div class="col-md-6 col-lg-4 item zoom-on-hover"><a href="project-page-1.php"><img class="img-fluid image" src="assets/img/project-images/project01.png"></a></div>
                    <div class="col-md-6 col-lg-4 item zoom-on-hover"><a href="project-page-2.php"><img class="img-fluid image" src="assets/img/project-images/project02.png"></a></div>
                    <div class="col-md-6 col-lg-4 item zoom-on-hover"><a href="project-page-3.php"><img class="img-fluid image" src="assets/img/project-images/project03.png"></a></div>
                </div>
            </div>
        </section>
        <section class="portfolio-block call-to-action border-bottom">
            <div class="container">
                <div class="d-flex justify-content-center align-items-center content">
                    <h3>Like what you see?</h3><a class="btn btn-outline-primary btn-lg" role="button" href="hire-me.php">Hire me</a></div>
            </div>
        </section>
                    ...
                    <div class="col-md-4">
                        <div class="card special-skill-item border-0">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Developing websites since 2015. I am expert at html5, css, php, javascript, python, etc. &amp; bootstrap, laravel frameworks.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card special-skill-item border-0">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Can design any powerpoint slide. Pro designed slides for presentation, seminar, conference, etc.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card special-skill-item border-0">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Good at designing any printing objects like- newsletter, brochure, visiting card, etc.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section data-aos="fade-up" data-aos-duration="1500" class="portfolio-block website gradient">
        <div class="container">
