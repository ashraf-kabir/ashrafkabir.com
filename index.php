...
<body>
    ...
    <main class="page landing-page">
        ...
        <section class="portfolio-block cv">
            <div class="container">
                <div class="work-experience group">
                    ...
                    <div data-aos="zoom-in-left" class="item">
                        <div class="row">
                            <div class="col-6">
                                <h3>Translator</h3>
                                <h4 class="organization" style="font-size: 18px;">Google Translator</h4>
                            </div>
                ...
                <div class="education group">
                    ...
                    <div data-aos="zoom-in-up" data-aos-duration="1000" class="item">
                        <div class="row">
                            <div class="col-md-6">
                                <h3>Science</h3>
                                <h4 class="organization" style="font-size: 18px;">Dhanmondi Govt. Boys' High School</h4>
                            </div>
                ...
                <div class="group">
                    <div class="row">
                        <div class="col-md-12" data-aos="zoom-in-up" data-aos-duration="1500">
                            <div class="skills portfolio-info-card">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <h3>JavaScript</h3>
                                        <div class="progress">
                                            <div class="progress-bar" aria-valuenow="80" aria-valuemin="0"
                                                 aria-valuemax="100"
        ...
        <!--cv end-->
        <!--all projects start-->
        <section class="portfolio-block projects-cards" id="projects">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card border-0">
                            <a href="project-page-2.php">
                                <img class="card-img-top scale-on-hover" src="assets/img/project-images/project02.png"
                                     alt="Card Image">
                            </a>
                            <div class="card-body">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card border-0">
                            <a href="https://personalblog.ashrafkabir.com/" target="_blank">
                                <img class="card-img-top scale-on-hover"
                                     src="assets/img/project-images/personalblog.png"
                                     alt="Card Image">
                            </a>
                            <div class="card-body">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="card border-0">
                            <a href="http://fastlearn.ashrafkabir.com/" target="_blank">
                                <img class="card-img-top scale-on-hover" src="assets/img/project-images/project04.png"
                                     alt="Card Image">
                            </a>
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card special-skill-item border-0">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Developing websites since 2015. I am expert at html5, css, php,
                                                     javascript, python, etc. &amp; bootstrap, laravel frameworks.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card special-skill-item border-0">
                            ...
                            <div class="card-body">
                                <h3 class="card-title">Powerpoint Slide Design</h3>
                                <p class="card-text">Can design any powerpoint slide. Pro designed slides for
                                                     presentation, seminar, conference, etc.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card special-skill-item border-0">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Good at designing any printing objects like- newsletter, brochure,
                                                     visiting card, etc.</p>
                            </div>
                        </div>
                    </div>
    ...
    <!--contact info start-->
    <section class="portfolio-block cv" id="contact">
        <div class="group">
            <div class="row">
                <div class="col-md-6" data-aos="zoom-in-up" data-aos-duration="1500">
                    ...
                    <div class="contact-info portfolio-info-card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-9"><span>S. M. Ashraf Kabir</span></div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-9"><span>29 Kalyanpur, Dhaka 1207</span></div>
                        </div>
                        <div class="row">
                    ...
                    <div class="contact-info portfolio-info-card">
                        ...
                        <form data-bss-recipient="4c7cf26e9b3f2f682adc8d185716b13c">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="email" id="email" name="email2" required=""
                                       placeholder="Enter your email" inputmode="email">
                            </div>
                            <div class="form-group">
                                <label for="message">Message</label>
                                <textarea class="form-control" id="message" rows="5" name="msg2"
                                          placeholder="Write your message" maxlength="255" required=""
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-9 mb-1">
                                        ...
                                        <input class="form-control" id="hire-date" type="date" required="" name="date">
                                    </div>
                                    <div class="col-md-6 button mt-1">
